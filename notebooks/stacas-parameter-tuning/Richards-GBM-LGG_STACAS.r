######################################
# Run STACAS on Richards-GBM-LGG
# L.Richards
# June 14, 2021
######################################
...
inputSeurat <- "/cluster/projects/pughlab/projects/cancer_scrna_integration/data/Richards-GBM-LGG/Richards-GBM-LGG_seurat.rds"
filePrefix <- "Richards-GBM-LGG"
sampleCol <- "SampleID"
patientCol <- "PairID"
cellCol <- "SingleR_CollapsedLabels"
